...
function OurProducts() {
    return (
      <div className="our-products">
            ...
            <div className="our-products-products-item">
                 <div className="our-products-products-item-pict" style={{ backgroundImage:`url("../../our-products-products-item2.svg")`}}>
                    <div className="pict-name">New</div>
                 </div>
                 <div className="products-item-name">sofa</div>
                 <div className="products-item-description">Modern Sofa</div>
                  <div className="products-item-pricing-rating">
                      <div className="products-item-pricing">
                          <div className="products-item-pricing-new">
                                &#36;120
            ...
            <div className="our-products-products-item">
                 <div className="our-products-products-item-pict" style={{ backgroundImage:`url("../../our-products-products-item6.svg")`}}>
                    <div className="pict-name">New</div>
                 </div>
                 <div className="products-item-name">Bench</div>
                 <div className="products-item-description">Amalia Cowhide Bench</div>
                  <div className="products-item-pricing-rating">
                      <div className="products-item-pricing">
                          <div className="products-item-pricing-new">
                                &#36;130
            ...
            <div className="our-products-products-item">
                 <div className="our-products-products-item-pict" style={{ backgroundImage:`url("../../our-products-products-item8.svg")`}}>
                    <div className="pict-name">New</div>
                 </div>
                 <div className="products-item-name">Furniture</div>
                 <div className="products-item-description">Delicia 3 Piece Living Room</div>
                  <div className="products-item-pricing-rating">
                      <div className="products-item-pricing">
                          <div className="products-item-pricing-new">
                                &#36;120
